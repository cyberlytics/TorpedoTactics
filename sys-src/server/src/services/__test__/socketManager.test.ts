...
describe('preparationCompleted', ()=>{
    it('sets player ready', () =>{
        ...
        let grid: cellState[][] = Array.from({length:1}, () => Array.from({ length: 1 }, () => cellState.empty));
...
describe('shot', ()=>{
    it('Shot is correct handled', ()=> {
        ...
        let grid1: cellState[][] = Array.from({length:2}, () => Array.from({ length: 2 }, () => cellState.empty));
        let grid2: cellState[][] = Array.from({length:2}, () => Array.from({ length: 2 }, () => cellState.empty));
